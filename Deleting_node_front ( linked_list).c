...
std *deleting_node_at_front(std *head){				//*****function definition of deleting front node*****
	std *ptr=head;
	head=head->link;
	free(ptr);
	ptr=NULL;
...
int main(){
	...
	head=deleting_node_at_front(head);   //*******calling the function of deleting a node *******
